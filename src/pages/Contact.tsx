      ...
      <main className="space-y-4 sm:space-y-8">
        ...
        <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-white">
          <div 
            ...
            style={{
              background: 'radial-gradient(ellipse at center 80%, rgba(13, 148, 136, 0.15) 0%, transparent 70%)'
            }}
          />
          
          <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-6xl mx-auto">
            <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold text-teal-600 mb-6 leading-tight animate-on-scroll">
            ...
            <div className="space-x-4 animate-on-scroll">
              <Button 
                className="bg-teal-600 text-white px-8 py-4 rounded-full font-semibold text-lg hover:bg-teal-700 transition-colors"
              ...
              <Button 
                variant="outline"
                className="border-teal-600 text-teal-600 px-8 py-4 rounded-full font-semibold text-lg hover:bg-teal-50 transition-colors"
