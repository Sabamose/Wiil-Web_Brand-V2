        ...
        <section className="py-16 sm:py-24 bg-white">
          <div className="section-container">
            <div className="text-center mb-16">
              <h2 className="font-display text-3xl sm:text-4xl font-bold text-gray-900 mb-6 animate-on-scroll">
                How to reach us
              </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <Card className="p-8 text-center animate-on-scroll hover:shadow-lg transition-shadow">
            ...
            <div className="max-w-2xl mx-auto">
              <div className="animate-on-scroll">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button 
                    type="submit"
                    className="w-full bg-pulse-500 hover:bg-pulse-600 text-white font-semibold py-3"
                  >
                    Send Message
                  </Button>
                </form>
              ...
              <div className="animate-on-scroll">
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <a href="tel:+16283587097" className="text-pulse-500 hover:underline">
                      +1 (628)-358-7097
                    </a>
                  </div>
                  ...
                  <div>
                    ...
                    <a href="mailto:contact@wiil.io" className="text-pulse-500 hover:underline">
                      contact@wiil.io
                    </a>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="flex space-x-4">
                      <a 
                        ...
                        className="w-10 h-10 bg-pulse-500 rounded-full flex items-center justify-center text-white hover:bg-pulse-600 transition-colors"
                      >
