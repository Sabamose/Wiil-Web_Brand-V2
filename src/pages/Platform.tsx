      ...
      <main className="space-y-4 sm:space-y-8">
        ...
        >
          <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
            <h1 
              className="font-display text-5xl sm:text-6xl md:text-7xl lg:text-8xl font-bold text-white mb-8 leading-tight opacity-0 animate-fade-in" 
            ...
            <p 
              ...
              className="text-lg sm:text-xl md:text-2xl text-white/90 leading-relaxed opacity-0 animate-fade-in max-w-3xl mx-auto"
            >
