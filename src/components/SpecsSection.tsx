      ...
      <div className="container px-4 sm:px-6 lg:px-8 mx-auto">
        ...
        <div className="max-w-5xl pl-4 sm:pl-8">
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-display leading-tight mb-8 sm:mb-12">
            <span 
              className="block bg-clip-text text-transparent bg-gradient-to-r from-teal-500/80 via-teal-600 via-teal-600 via-teal-600/90 via-teal-700/80 to-teal-600/70 animate-pulse" 
              style={{
                textShadow: '0 0 20px rgba(13, 148, 136, 0.5), 0 0 40px rgba(13, 148, 136, 0.3), 0 0 60px rgba(13, 148, 136, 0.2)',
