      ...
      <div className="mx-auto max-w-6xl px-4 sm:px-6">
        ...
        <div className="mt-8 flex flex-col items-stretch gap-3 sm:mt-10 sm:flex-row sm:items-center sm:justify-between">
          ...
          <button className="relative h-11 rounded-full bg-teal-50/20 backdrop-blur-md border border-teal-200/30 px-5 text-sm font-medium text-teal-800 shadow-[0_8px_32px_0_rgba(20,184,166,0.25)] hover:bg-teal-100/30 transition-all duration-300 overflow-hidden group">
            ...
            <div className="absolute inset-0 bg-gradient-to-br from-red-400/30 via-red-300/15 to-teal-400/25 backdrop-blur-sm opacity-60 group-hover:opacity-80 transition-all duration-500"></div>
...
function StepCard({ title, index, children }: { title: string; index: number; children: React.ReactNode }) {
  return (
    <div className="relative rounded-2xl border border-slate-200 bg-white/90 p-4 sm:p-5 shadow-[0_8px_32px_-8px_rgba(0,0,0,0.12)]">
...
function GhostOption({ icon, label }: { icon: React.ReactNode; label: string }) {
  return (
    <div className="flex items-center gap-3 rounded-2xl border border-slate-200 bg-white p-4 shadow-[0_4px_16px_-4px_rgba(0,0,0,0.08)]">
...
function IconTile({ icon, label }: { icon: React.ReactNode; label: string }) {
  return (
    <div className="flex flex-col items-center gap-2 rounded-2xl border border-slate-200 bg-white p-4 text-center shadow-[0_4px_16px_-4px_rgba(0,0,0,0.08)]">
      <div className="rounded-xl bg-slate-50 p-2 ring-1 ring-slate-200">{icon}</div>
