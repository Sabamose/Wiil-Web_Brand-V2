...
function StepCard({ title, index, children }: { title: string; index: number; children: React.ReactNode }) {
  return (
    <div className="relative rounded-2xl border border-slate-200 bg-white/90 p-4 sm:p-5 shadow-[0_8px_32px_-8px_rgba(0,0,0,0.1)] transform-gpu [transform-style:preserve-3d] [transform:perspective(1000px)_rotateX(2deg)_rotateY(-2deg)_translateZ(20px)]">
...
function GhostOption({ icon, label }: { icon: React.ReactNode; label: string }) {
  return (
    <div className="flex items-center gap-3 rounded-2xl border border-slate-200 bg-white p-4 shadow-[0_4px_16px_-4px_rgba(0,0,0,0.1)] transform-gpu [transform-style:preserve-3d] [transform:perspective(800px)_rotateX(5deg)_translateZ(10px)]">
...
function IconTile({ icon, label }: { icon: React.ReactNode; label: string }) {
  return (
    <div className="flex flex-col items-center gap-2 rounded-2xl border border-slate-200 bg-white p-4 text-center shadow-[0_4px_16px_-4px_rgba(0,0,0,0.1)] transform-gpu [transform-style:preserve-3d] [transform:perspective(800px)_rotateX(5deg)_translateZ(10px)]">
      <div className="rounded-xl bg-slate-50 p-2 ring-1 ring-slate-200 shadow-sm">{icon}</div>
