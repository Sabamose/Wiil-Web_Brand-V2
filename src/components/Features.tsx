...
const FeatureCard = ({ icon, title, description, index }: FeatureCardProps) => {
  ...
  return (
    ...
    >
      <div className="rounded-full bg-teal-50 w-72 h-72 sm:w-96 sm:h-96 flex items-center justify-center text-teal-600 mb-4 sm:mb-5">
        {icon}
      </div>
    ...
    <section className="py-12 sm:py-16 md:py-20 pb-0 relative bg-gray-50" id="features" ref={sectionRef}>
      <div className="section-container">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            icon={<img src="/lovable-uploads/cf8bf532-5c0f-429d-b86a-36d70f9c0fb3.png" alt="Voice Calls" className="w-72 h-72 sm:w-96 sm:h-96 object-contain" />}
            title="Voice Calls"
          ...
          />
          <FeatureCard
            icon={<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 sm:w-6 sm:h-6"><path d="M22 2L11 13l-3-3-6 6L7 21l5-5 9-9V2z"></path></svg>}
            title="SMS"
