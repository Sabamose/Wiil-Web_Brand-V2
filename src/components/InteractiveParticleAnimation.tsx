...
const InteractiveParticleAnimation = () => {
  ...
  const colors = ['#047857', '#0f766e', '#0d9488', '#14b8a6', '#5eead4']; // Added a stronger, darker teal
  ...
  useEffect(() => {
    ...
    const initParticles = () => {
      ...
      for (let i = 0; i < maxParticles; i++) {
        ...
        const radius = Math.sqrt(Math.random()) * (canvas.width / 2.0); // Changed divisor from 2.2 to 2.0 to increase the circle size
