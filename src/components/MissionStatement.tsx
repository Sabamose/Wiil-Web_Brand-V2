  ...
  return <section className="py-12 bg-white relative" id="mission" ref={sectionRef}>
      <div className="section-container opacity-0 animate-on-scroll">
        ...
        <div className="mt-16 flex justify-center">
          <img src="/lovable-uploads/2e37e38b-9885-4e58-83c1-28f146f40a90.png" alt="Isometric office environment showing various business departments using AI-powered conversational interfaces" className="max-w-5xl h-auto" />
        </div>
      </div>
    </section>;
};
