      ...
      <div className="section-container opacity-0 animate-on-scroll">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl text-gray-600 max-w-3xl leading-relaxed">
            We provide simple, human-centered AI that empowers businesses of all sizes to deliver outstanding customer experiences. Let people focus on what they do best, and we'll handle the rest.
          </p>
        </div>
        
        <div className="mt-16 flex justify-center">
          <img src="/lovable-uploads/2e37e38b-9885-4e58-83c1-28f146f40a90.png" alt="Isometric office environment showing various business departments using AI-powered conversational interfaces" loading="lazy" className="max-w-full h-auto rounded-2xl shadow-2xl border-8 border-white" />
        </div>
      </div>
    </section>;
};
